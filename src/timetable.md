...
本講義では、強力なコーディング能力をもつ生成AIを「相棒」として、科学計算をJuliaで行うための基礎を学ぶ。  
    前半3コマは品岡・水野が担当し、Julia の環境構築から出発して、GitHub を起点とする開発フローを体験する。短い題材コードを用いて、型・多重ディスパッチ・broadcast といった Julia の抽象化を読み解きつつ、生成AIの提案をテストと計測で検証しながら改良していく流れを実践する。
